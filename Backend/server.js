...
// --- 1. CLOUD MYSQL CONNECTION (AIVEN) ---
...
sequelize.authenticate()
    .then(() => console.log('✅ eSakay connected to MySQL Cloud (Aiven)'))
...
const Trip = sequelize.define('Trip', {
    ...
    isDeleted: { type: DataTypes.BOOLEAN, defaultValue: false } // Para sa Recycle Bin
});
